...
function Nav() {
  return (
    <div className='grid grid-cols-12 bg-black'>
      <div className='col-span-6 text-lg h-14 ps-10 pt-3 font-bold bg-white rounded-tr-lg'>
      ...
      <div className='bg-black text-white col-span-6 flex justify-end'>
        <button className='first w-20 focus:bg-white focus:text-black focus:rounded-tr-lg'>Welcome</button>
